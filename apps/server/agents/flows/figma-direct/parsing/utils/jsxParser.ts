 ...
 * 解析 TSX 源码，提取结构信息
 */
// const result = parseTsxCode(`
//   const imgLogo = "https://cdn.com/logo.png";
...
//     {
//       name: "Header",
//       rawCode: "function Header() { return <h1>Hello Header</h1>; }",
//       loc: { startLine: 8, endLine: 10 }
//     },
//     {
//       name: "Hero",
//       rawCode: "const Hero = () => { return <section>Hero Section</section>; }",
//       loc: { startLine: 12, endLine: 14 }
//     }
//   ],
//   jsxElements: [
//     {
//       name: "Header",
//       // 或 JSX 节点结构（取决于 extractTopLevelJsx 实现）
//     },
//     {
//       name: "Hero"
//     }
